...
The Semantic branch analyses decoded URL/payload content. Its active model is
the accepted `semantic-2026.02` hashed character 3–5 gram classifier.

This folder retains the compact dataset catalogue, cleaning/source manifests and
