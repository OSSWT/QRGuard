...
|---|---|---|
| Structural | **`structural-2026.03-r01`** | Promoted locally; one artifact for Gallery and Camera |
| Semantic | `semantic-2026.02` | Frozen accepted model |
| Decision | **`decision-2026.03-r05`** | Promoted locally; Safe < 26, Blocked >= 76 |
| Full stack | r01 + r05 | Production-path 120-row and HTTP gates passed |

GitHub and the external Render services still contain the previous deployed
revision until the reviewed commit/push/deploy step is completed.
...
6. GitHub push, Render build and remote smoke. **Pending.**
