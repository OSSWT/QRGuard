...
abstract class MobileScannerPlatform extends PlatformInterface {
  ...
  /// Query CameraX exposure-compensation support and range.
  Future<ExposureCompensationState> getExposureCompensationState() {
    throw UnimplementedError(
      'getExposureCompensationState() has not been implemented.',
    );
  }

  /// Apply a supported CameraX exposure-compensation index.
  Future<int> setExposureCompensationIndex(int index) {
    throw UnimplementedError(
      'setExposureCompensationIndex() has not been implemented.',
    );
  }
